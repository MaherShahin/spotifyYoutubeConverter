...
public class SearchService {
     ...
     */
    public List<SearchResult> getVideos(String queryTerm) {
        ...
        try {
            ...
            youtube = new YouTube.Builder(YoutubeAuthenticationService.HTTP_TRANSPORT, YoutubeAuthenticationService.JSON_FACTORY, new HttpRequestInitializer() {
